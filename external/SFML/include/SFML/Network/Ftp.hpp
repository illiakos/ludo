...
public:
  ...
  public:
    ...
    enum Status {
      ...
      SystemType = 215,   //!< NAME system type, where NAME is an official system name from the list
      ...
      InsufficientStorageSpace = 452, //!< Requested action not taken; insufficient storage space in
      ...
      InvalidResponse = 1000,  //!< Not part of the FTP standard, generated by SFML when a received
      ...
      InvalidFile = 1003 //!< Not part of the FTP standard, generated by SFML when a local file
