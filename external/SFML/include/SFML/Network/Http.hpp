...
public:
  ...
  public:
    ...
    enum Status {
      ...
      ResetContent = 205,   //!< The server informs the client that it should clear the view (form)
                            //!< that caused the request to be sent
      PartialContent = 206, //!< The server has sent a part of the resource, as a response to a
                            //!< partial GET request
      ...
      NotModified = 304, //!< For conditional requests, means the requested page hasn't changed and
