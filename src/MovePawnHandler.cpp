...
auto moveEvent = std::dynamic_pointer_cast<MovePawnEvent>(event);
    if (moveEvent) {
        ...
        switch (pawn->getContext()) {
          case TileContext::Base:
            ...
            if (steps == 6) {
                ...
                auto startingTile = tileManager.findTileByContextAndPosition(TileContext::Walkable, startingTileId);
                if (!startingTile) {
                ...
                auto newDimensions = Dimensions(tileDimensions.x, tileDimensions.y, pawn->getDimensions().dx, pawn->getDimensions().dy);
        ...
        /**/
        /*        auto tile = tileManager.findTileByContextAndPosition(TileContext::Finishing, finishingTilePosition);*/
        ...
        /*            return;*/
        /*        } else {*/
        /*            std::cout << "Pawn " << pawn->getId() << " cannot enter the finishing tiles of another team.\n";*/
        /*            return;*/
        /*        }*/
        /*    }*/
        /**/
