...
TurnManager::TurnManager (EventLoop &loop)
    : eventLoop (loop), currentPlayerId (0), totalPlayers (0), gameOverCallback (nullptr) {
}

void TurnManager::startTurn (int startingPlayer, std::function<void ()> onGameOver) {
...
int TurnManager::getCurrentPlayerId () const {
